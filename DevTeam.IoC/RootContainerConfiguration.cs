namespace DevTeam.IoC
{
    ...
    internal sealed class RootContainerConfiguration: IConfiguration
    {
        ...
        private static readonly IEnumerable<IKey> CreationContextKeys = LowLevelRegistration.CreateKeys<CreationContext>();
        private static readonly IEnumerable<IKey> ResolverContextKeys = LowLevelRegistration.CreateKeys<ResolverContext>();
        private static readonly IEnumerable<IKey> RegistryContextKeys = LowLevelRegistration.CreateKeys<RegistryContext>();
        ...
        public IEnumerable<IDisposable> Apply(IContainer container)
        {
            ...
            yield return LowLevelRegistration.RawRegister(container, ResolvingKeys, ctx => new Resolving<IResolver>(container));
            yield return LowLevelRegistration.RawRegister(container, RegistrationKeys, ctx => new Registration<IContainer>(ctx.ResolverContext.Container.Resolve().Instance<IFluent>(), container));
