namespace DevTeam.IoC
{
    ...
    internal sealed class Resolver<TState1, TState2, TState3, TState4, TContract> : Resolver<TContract>, IResolver<TState1, TState2, TState3, TState4, TContract>, IProvider<TState1, TState2, TState3, TState4, TContract>
    {
        ...
        {
            if (_resolving.TryInstance(out object objInstance, state1, state2, state3, state4))
            {
