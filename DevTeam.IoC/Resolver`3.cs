namespace DevTeam.IoC
{
    ...
    internal class Resolver<TState1, TState2, TContract> : Resolver<TContract>, IResolver<TState1, TState2, TContract>, IProvider<TState1, TState2, TContract>, IFuncProvider
    {
