namespace DevTeam.IoC
{
    ...
    internal sealed class ConfigurationFromSringData: IConfiguration
    {
        ...
        private IConfiguration CreateConfiguration([NotNull] string description)
        {
            ...
            if(_resolver.Resolve().Tag(_configurationType).State<IConfigurationDescriptionDto>(0).TryInstance(out IConfiguration configuration, configurationDescriptionDto))
            {
